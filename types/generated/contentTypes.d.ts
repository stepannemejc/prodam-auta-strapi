...
export interface ApiCarCar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AsistencniSystemy: Schema.Attribute.Blocks;
    Barva: Schema.Attribute.String;
    BezpecnostniSystemy: Schema.Attribute.Blocks;
    ...
    Objem: Schema.Attribute.Integer;
    OdpocetDPH: Schema.Attribute.Boolean;
    Ostatni: Schema.Attribute.Blocks;
    Palivo: Schema.Attribute.Enumeration<
      [
        'Benz\u00EDn',
        'Diesel',
        'Elektrick\u00FD',
    ...
    >;
    Pohon: Schema.Attribute.Enumeration<
      [
        'Pohon p\u0159edn\u00EDch kol',
        'Pohon zadn\u00EDch kol',
        'Pohon v\u0161ech kol (4x4)',
    ...
    >;
    PosledniServis: Schema.Attribute.Date;
    Prevodovka: Schema.Attribute.Enumeration<
      ['Manu\u00E1ln\u00ED', 'Automatick\u00E1', 'Poloautomatick\u00E1']
    >;
